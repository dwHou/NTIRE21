...
parser.add_argument('--batchSize', type=int, default=48, help='training batch size') # 37716 // batchsize
parser.add_argument('--testBatchSize', type=int, default=1, help='testing batch size')
parser.add_argument('--loss', type=str, default='1*VGG54+0.01*GDL', help='loss functions')
