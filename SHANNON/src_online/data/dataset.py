...
def get_training_hqf():
    train_txt = '/cfs_data/devonnhou/NTIRE2021/Dataset/FixedQP/train_hqf_pairs.txt'
    return ntire_dataset(train_txt, 'train')


def get_test_hqf():
    test_txt = '/cfs_data/devonnhou/NTIRE2021/Dataset/FixedQP/val_hqf_pairs.txt'
    return ntire_dataset(test_txt, 'test')

def get_training_lqf():
    train_txt = '/cfs_data/devonnhou/NTIRE2021/Dataset/FixedQP/train_lqf_pairs.txt'
    return ntire_dataset(train_txt, 'train')


def get_test_lqf():
    test_txt = '/cfs_data/devonnhou/NTIRE2021/Dataset/FixedQP/val_lqf_pairs.txt'
    return ntire_dataset(test_txt, 'test')
    ...
    def _load_png(self, index):
        ...
        try:
            ...
            try:
                ...
                try:
                    input7 = Image.open('/cfs_data/devonnhou/NTIRE2021/Dataset/FixedQP/' + input7).convert('RGB')
                    try:
        ...
        if mod == 0:
            ...
            list_in = [np.asarray(input1), np.asarray(input4), np.asarray(input5)]
