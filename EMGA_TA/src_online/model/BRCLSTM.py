...
class BiConvLSTMCell(nn.Module):
    ...
    def __init__(self, input_dim, hidden_dim, kernel_size, bias):
        ...
        '''self.conv = CellConv(in_channels=self.input_dim + self.hidden_dim,
    ...
    def init_hidden(self, batch_size, image_size):
        ...
        return (torch.zeros(batch_size, self.hidden_dim, height, width).cuda(),torch.zeros(batch_size, self.hidden_dim, height, width).cuda())


class BRCLSTM(nn.Module):

    def __init__(self, input_dim, hidden_dim, kernel_size, num_layers,
                 bias=True, return_all_layers=False):
        super(BRCLSTM, self).__init__()
        ...
        for i in range(0, self.num_layers):
            ...
            cell_list.append(BiConvLSTMCell(input_dim=cur_input_dim,
